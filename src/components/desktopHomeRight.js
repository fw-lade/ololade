    ...
    <>
      ...
      <div className="darken flex flex-col gap-y-8 md:gap-y-3">
        <div className="flex flex-col bg-box-bg p-10 transition-all duration-300 md:hover:scale-110">
          ...
          <p className="my-3 min-h-[5rem] text-xs font-semibold tracking-wider text-dark-grey md:h-16">
            Developed an e-commerce website inspired by Nike,
            featuring a fully functional products page, add-to-cart, and
            remove-from-cart functionalities. Built using React JS and Redux
            Toolkit, the project ensures seamless state management for a smooth
            shopping experience. The website includes dynamic product rendering,
            interactive cart updates, and a modern, responsive design optimized
            for fast performance and cross-device compatibility.
          </p>
          <div className="my-8 flex items-center gap-x-4">
            <a
